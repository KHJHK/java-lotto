...
public class WinningLotto{
    private final String DUPLICATE_BONUSNUM_ERROR = "[ERROR]보너스 번호는 당첨 번호와 중복될 수 없습니다.";
    private final String OUT_OF_LOTTO_SIZE_ERROR = "[ERROR]로또 번호는 정확히 6개가 입력되어야 합니다.";
